...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gars_field-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14183&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gars_field-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gars_field` can be installed with:

```
conda install gars_field
```

It is possible to list all of the versions of `gars_field` available on your platform with:
